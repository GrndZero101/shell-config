...
typeset -ga SHELL_FORTRESS_DEFAULT_MODULES
typeset -ga SHELL_FORTRESS_LOCAL_MODULES
typeset -ga SHELL_FORTRESS_DISABLED_MODULES
typeset -ga SHELL_FORTRESS_EFFECTIVE_MODULES
...
SHELL_FORTRESS_DEFAULT_MODULES=(${SHELL_PROFILE_DEFAULT_MODULES[@]:-})
SHELL_FORTRESS_DEFAULT_MODULES=(${(u)SHELL_FORTRESS_DEFAULT_MODULES})
SHELL_FORTRESS_LOCAL_MODULES=(${(u)SHELL_FORTRESS_LOCAL_MODULES})
SHELL_FORTRESS_DISABLED_MODULES=(${(u)SHELL_FORTRESS_DISABLED_MODULES})
SHELL_FORTRESS_EFFECTIVE_MODULES=(${SHELL_FORTRESS_DEFAULT_MODULES} ${SHELL_FORTRESS_LOCAL_MODULES})
SHELL_FORTRESS_EFFECTIVE_MODULES=(${(u)SHELL_FORTRESS_EFFECTIVE_MODULES})
if (( ${#SHELL_FORTRESS_DISABLED_MODULES[@]} )); then
  SHELL_FORTRESS_EFFECTIVE_MODULES=(${SHELL_FORTRESS_EFFECTIVE_MODULES:|SHELL_FORTRESS_DISABLED_MODULES})
fi
